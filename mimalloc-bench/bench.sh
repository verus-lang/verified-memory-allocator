...
readonly alloc_all="sys dh ff fg gd hd hm hml iso je lp lt mi mi-sec mng mesh nomesh pa rp sc scudo sg sm sn sn-sec tbb tc tcg dmi xmi xsmi xdmi rust-jemalloc-wrapper vmi"
...
alloc_lib_add "rust-jemalloc-wrapper" "$localdevdir/../../rust-jemalloc-wrapper/target/release/librust_jemalloc_wrapper$extso"
alloc_lib_add "vmi" "$localdevdir/../../build/libverus-mimalloc$extso"
